...
# Korekcija malih odstupanja
def adjust_for_small_drift(weight):
    # Ako je težina vrlo blizu 0, postavi na 0
    if -0.25 <= weight <= 0.25:
        return 0.0
    return weight

try:
    # Učitavanje postojeće konfiguracije
    ...
    while True:
        ...
        weight = adjust_for_small_drift(weight)  # Primjena korekcije
